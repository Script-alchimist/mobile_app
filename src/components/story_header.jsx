  ...
  return (
    <View style={styles.headpattern}>
      ...
      <View style={styles.menus}>
        ...
        >
            <Text 
                style={actif === 'all' ? styles.buttonText : styles.desactive}
            >
                Tous
            </Text>
        </TouchableOpacity>
        ...
        >
            <Text 
                style={actif === 'ticket' ? styles.buttonText : styles.desactive}
            >
                Tickets
            </Text>
        </TouchableOpacity>
        ...
        >
            <Text 
                style={actif === 'livraison' ? styles.buttonText : styles.desactive}
            >
                Livraison
            </Text>
        </TouchableOpacity>
        ...
        >
            <Text   
                style={actif === 'pressing' ? styles.buttonText : styles.desactive}
            >
                Pressing
            </Text>
        </TouchableOpacity>
